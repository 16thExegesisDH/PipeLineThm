#this is the script for the normalization, it contains function working with regex to normalize the latin from the 16th century in direction of classical latin. 
import sys
import os
