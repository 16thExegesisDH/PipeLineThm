...
<!-- Extract the title from short title -->
                ...
                <link href="CSS/updated_3_toc.css" rel="stylesheet"/>
                <script src="JS/script_toc.js" defer="defer"></script>
            </head>
            <body>
            ...
            <xsl:for-each select="pb">
                ...
                <xsl:element name="div">
                    ...
                    <xsl:element name="div">
                        ...
                        <xsl:element name="img">
                            <xsl:attribute name="src">
                                <xsl:value-of select="concat('IMG/', substring-after(@corresp, 'f'),'.jpg')"/>
                            </xsl:attribute>
