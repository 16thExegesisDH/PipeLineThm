...
<!-- For now 5.06.25 I keep this old file for have an Idea of the first TOC, in case it changes too much because of the insertion of the DropCapital inside the TOC. 
this change add a few more loop and condition in script
the new condition have been added in the TOC and in the MainZoneHaed id-->
